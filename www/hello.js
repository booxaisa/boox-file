 ...
 */
booxfile.getDirectoryForPurpose = function(purpose, options, successCallback, failureCallback) {
    argscheck.checkArgs('sOfF', 'booxfile.getDirectoryForPurpose', arguments);
    ...
    exec(augmentedSuccessCallback, failureCallback, "BooxFile", "getDirectoryForPurpose", args);
};

booxfile.getDataDirectory = function(syncable, successCallback) {
    argscheck.checkArgs('*f', 'booxfile.getDataDirectory', arguments);
    booxfile.getDirectoryForPurpose('data', { syncable: syncable }, successCallback);
};

// On Android, this is the root of the SD card.
booxfile.getDocumentsDirectory = function(successCallback) {
    booxfile.getDirectoryForPurpose('documents', { syncable: true, sandboxed: false }, successCallback);
};

booxfile.getTempDirectory = function(successCallback) {
    booxfile.getDirectoryForPurpose('temp', null, successCallback);
};

booxfile.getCacheDirectory = function(successCallback) {
    booxfile.getDirectoryForPurpose('cache', null, successCallback);
};
